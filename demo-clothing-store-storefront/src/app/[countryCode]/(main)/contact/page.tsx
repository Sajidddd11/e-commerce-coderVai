                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:support@zahan.com.bd" className="text-blue-600 hover:underline">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-700">
                                            ৫০/এ, পুরানা পল্টন, হাবিব সেন্টার,<br />
                                            (৬ষ্ঠ তলা), ঢাকা-১০০০<br />
                                            Bangladesh
                                        </p>
