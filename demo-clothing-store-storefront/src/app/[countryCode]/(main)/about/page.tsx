        ...
        <div className="min-h-screen bg-black">
            ...
            <section className="relative w-full px-6 py-20 md:py-28">
                <div className="max-w-5xl mx-auto text-center mb-16">
                    <p className="text-xs font-semibold tracking-[0.25em] uppercase mb-6 text-[#56aebf]/90 animate-fade-in-top">
                        Premium Collection
                    </p>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-white animate-fade-in-top leading-tight" style={{ animationDelay: '0.1s' }}>
                        About <span className="text-[#56aebf]">ZAHAN</span>
                    </h1>
                ...
                <div className="w-full max-w-7xl mx-auto animate-fade-in-top" style={{ animationDelay: '0.3s' }}>
                    <div className="relative w-full h-[200px] xsmall:h-[240px] small:h-[320px] medium:h-[400px] large:h-[480px] overflow-hidden rounded-2xl border border-[#56aebf]/40 shadow-[0_0_20px_rgba(86,174,191,0.3),0_0_40px_rgba(86,174,191,0.1)] hover:shadow-[0_0_30px_rgba(86,174,191,0.5),0_0_60px_rgba(86,174,191,0.2)] hover:border-[#56aebf]/60 transition-all duration-500">
                        <Image
                            src="/about-hero.jpg"
            ...
            <section className="py-20 md:py-28 px-6">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-2xl p-10 md:p-14 shadow-xl hover:border-white/20 transition-all duration-300">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#56aebf]">
                            About ZAHAN
                        </h2>
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row gap-4">
                            <a
                                href="/store"
                                className="group px-8 py-4 bg-[#56aebf] hover:bg-[#458f9e] text-black font-semibold rounded-xl transition-all duration-300 text-center shadow-lg hover:shadow-[0_0_30px_rgba(86,174,191,0.5)] hover:-translate-y-0.5"
                            >
                                Explore Products
                            </a>
                            <a
                                href="/contact"
                                className="px-8 py-4 border-2 border-[#56aebf]/50 text-[#56aebf] hover:bg-[#56aebf]/10 hover:border-[#56aebf] font-semibold rounded-xl transition-all duration-300 text-center hover:-translate-y-0.5"
                            >
                                Contact Support
                            </a>
                        </div>
            ...
            <section className="py-20 md:py-28 px-6 bg-black/20">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[#56aebf]">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                        ...
                        <div className="group bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-2xl border border-[#56aebf]/20 rounded-2xl p-8 hover:border-[#56aebf]/40 hover:shadow-[0_8px_32px_rgba(86,174,191,0.15)] transition-all duration-500 hover:-translate-y-1">
                            <div className="w-16 h-16 mb-6 rounded-2xl bg-[#56aebf]/20 flex items-center justify-center border border-[#56aebf]/30 group-hover:scale-110 transition-transform duration-300">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-[#56aebf]">
                            ...
                            <p className="text-sm uppercase tracking-wider text-[#56aebf]/80 font-semibold mb-3">6+ Years Experience</p>
                        ...
                        <div className="group bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-2xl border border-[#56aebf]/20 rounded-2xl p-8 hover:border-[#56aebf]/40 hover:shadow-[0_8px_32px_rgba(86,174,191,0.15)] transition-all duration-500 hover:-translate-y-1">
                            ...
                            <p className="text-sm uppercase tracking-wider text-[#56aebf]/80 font-semibold mb-3">Quality Certified</p>
                            <p className="text-base leading-relaxed text-white/65">
                        ...
                        <div className="group bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-2xl border border-[#56aebf]/20 rounded-2xl p-8 hover:border-[#56aebf]/40 hover:shadow-[0_8px_32px_rgba(86,174,191,0.15)] transition-all duration-500 hover:-translate-y-1">
                            ...
                            <p className="text-sm uppercase tracking-wider text-[#56aebf]/80 font-semibold mb-3">Fast Delivery</p>
                            <p className="text-base leading-relaxed text-white/65">
            ...
            <section className="py-20 md:py-28 px-6">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-20 text-center text-[#56aebf]">
                        How ZAHAN Works
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-10 md:gap-12">
                        ...
                        <div className="relative flex flex-col items-center text-center group">
                            <div className="w-20 h-20 rounded-2xl bg-[#56aebf]/20 flex items-center justify-center mb-6 border-2 border-[#56aebf]/50 shadow-lg group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(86,174,191,0.4)] transition-all duration-300">
                                <span className="text-3xl font-bold text-[#56aebf]">01</span>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold mb-4 text-white">
                        ...
                        <div className="relative flex flex-col items-center text-center group">
                            <div className="w-20 h-20 rounded-2xl bg-[#56aebf]/20 flex items-center justify-center mb-6 border-2 border-[#56aebf]/50 shadow-lg group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(86,174,191,0.4)] transition-all duration-300">
                                <span className="text-3xl font-bold text-[#56aebf]">02</span>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold mb-4 text-white">
                                Ready Stock & Pricing
                            </h3>
                        ...
                        <div className="relative flex flex-col items-center text-center group">
                            <div className="w-20 h-20 rounded-2xl bg-[#56aebf]/20 flex items-center justify-center mb-6 border-2 border-[#56aebf]/50 shadow-lg group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(86,174,191,0.4)] transition-all duration-300">
                                <span className="text-3xl font-bold text-[#56aebf]">03</span>
                            </div>
                            <h3 className="text-xl md:text-2xl font-bold mb-4 text-white">
            ...
            <section className="py-24 md:py-32 px-6 bg-gradient-to-b from-transparent to-black/30">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#56aebf] leading-tight">
