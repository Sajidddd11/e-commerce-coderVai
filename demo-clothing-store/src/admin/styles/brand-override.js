// Replace "Medusa" with "Al-Ariya" on admin login page and change logo
(function () {
...
(function () {
  ...
  console.log("[Al-Ariya] File size limit enforcement active: max " + MAX_FILE_SIZE_LABEL);
})();
...
(function () {
  ...
  function saveSort() {
    ...
    if (order) {
      ...
      console.log("[Al-Ariya] Products sort saved:", order);
    }
  }
  ...
  function restoreSort() {
    ...
    console.log("[Al-Ariya] Restoring products sort:", savedOrder, "→", newUrl);
  ...
  console.log("[Al-Ariya] Products sort memory active");
})();
